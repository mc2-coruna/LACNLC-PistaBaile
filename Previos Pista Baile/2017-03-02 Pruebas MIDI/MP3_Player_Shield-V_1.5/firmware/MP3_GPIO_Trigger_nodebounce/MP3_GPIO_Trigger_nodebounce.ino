...
#define DEBOUNCE  100
  ...
  else if(digitalRead(trigger1) == LOW ) {foundTrigger = 1;} 

  else if(digitalRead(trigger2) == LOW) {foundTrigger = 2;}

  else if(digitalRead(trigger3) == LOW) {foundTrigger = 3;}

  else if(digitalRead(trigger4) == LOW) {foundTrigger = 4;}
